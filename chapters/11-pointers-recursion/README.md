...
- **[Άθροισμα δύο δεικτών](../../questions/kahoot/kahoot-pointer-addition.md)** (28% σωστές): Το 28% επέλεξε `166` και το 22% `84`, θεωρώντας ότι δύο δείκτες προστίθενται σαν ακέραιοι. Η C επιτρέπει δείκτη ± ακέραιο και διαφορά δύο δεικτών, όχι όμως άθροισμα δεικτών.
- **[Δείκτης συν 4 σε δεκαεξαδικό](../../questions/kahoot/kahoot-pointer-plus-int-hex.md)** (31% σωστές): Το 32% επέλεξε `0x4C` και το 22% `0x46`. Οι δεύτεροι ξέχασαν ότι το `+ 4` σημαίνει 4 × `sizeof(int)` bytes, ενώ οι πρώτοι πρόσθεσαν σωστά 16 bytes, αλλά μπέρδεψαν τη δεκαεξαδική πρόσθεση (16 = `0x10`).
- **[Αύξηση του ίδιου του δείκτη](../../questions/kahoot/kahoot-pointer-increment-scalar.md)** (37% σωστές): Το 25% επέλεξε `42`, θεωρώντας ότι το `ptr++` αυξάνει την τιμή του `x`. Στην πραγματικότητα αλλάζει τη διεύθυνση που κρατά ο δείκτης, όχι την τιμή στην οποία δείχνει.
- **[Μέγεθος δεικτών](../../questions/kahoot/kahoot-pointer-size.md)** (46% σωστές): Το 49% απάντησε False, μπερδεύοντας το μέγεθος του δείκτη με το μέγεθος του τύπου στον οποίο δείχνει. Κάθε δείκτης κρατά μια διεύθυνση, άρα όλοι έχουν το ίδιο μέγεθος (8 bytes σε 64-bit συστήματα).
- **[Διεύθυνση και ακέραιος](../../questions/kahoot/kahoot-address-is-integer.md)** (50% σωστές): Το 47% απάντησε False, ίσως επειδή η διεύθυνση έχει τύπο δείκτη ή επειδή τη βλέπουμε σε δεκαεξαδικό. Όμως κάθε διεύθυνση είναι ο αύξων αριθμός ενός byte στη μνήμη, δηλαδή ακέραιος.
- **[Η τιμή του NULL](../../questions/kahoot/kahoot-null-is-zero.md)** (65% σωστές): Το 28% απάντησε False, θεωρώντας το `NULL` ειδική τιμή χωρίς αριθμητική αναπαράσταση. Στην πράξη το `NULL` είναι η διεύθυνση 0.
- **[*(ptr + 4) και ptr[4]](../../questions/kahoot/kahoot-ptr-offset-equals-index.md)** (67% σωστές): Το 26% απάντησε False, θεωρώντας ότι οι αγκύλες είναι κάτι διαφορετικό από την αριθμητική δεικτών. Στην C το `ptr[n]` ορίζεται ακριβώς ως `*(ptr + n)`.
...
- [Τερματισμός αναδρομής](../../questions/kahoot/kahoot-recursion-terminates.md): 87% σωστές απαντήσεις
- [Πίνακας και δείκτης](../../questions/kahoot/kahoot-array-vs-pointer.md): 71% σωστές απαντήσεις
- [*(ptr + 4) και ptr[4]](../../questions/kahoot/kahoot-ptr-offset-equals-index.md): 67% σωστές απαντήσεις
- [Η τιμή του NULL](../../questions/kahoot/kahoot-null-is-zero.md): 65% σωστές απαντήσεις
- [Η τιμή του ptr + 1](../../questions/kahoot/kahoot-pointer-plus-one.md): 61% σωστές απαντήσεις
- [Διεύθυνση και ακέραιος](../../questions/kahoot/kahoot-address-is-integer.md): 50% σωστές απαντήσεις
- [Αλλαγή μεταβλητής και δείκτης](../../questions/kahoot/kahoot-variable-increment-via-ptr.md): 48% σωστές απαντήσεις
- [Μέγεθος δεικτών](../../questions/kahoot/kahoot-pointer-size.md): 46% σωστές απαντήσεις
- [Αύξηση του ίδιου του δείκτη](../../questions/kahoot/kahoot-pointer-increment-scalar.md): 37% σωστές απαντήσεις
- [Η έκφραση *&x](../../questions/kahoot/kahoot-deref-address-of.md): 35% σωστές απαντήσεις
- [Αύξηση μέσω δείκτη](../../questions/kahoot/kahoot-deref-increment.md): 34% σωστές απαντήσεις
- [Δείκτης συν 4 σε δεκαεξαδικό](../../questions/kahoot/kahoot-pointer-plus-int-hex.md): 31% σωστές απαντήσεις
- [Άθροισμα δύο δεικτών](../../questions/kahoot/kahoot-pointer-addition.md): 28% σωστές απαντήσεις
- [Δείκτης στη μέση πίνακα](../../questions/kahoot/kahoot-ptr-index-offset.md): 12% σωστές απαντήσεις
