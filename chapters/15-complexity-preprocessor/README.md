...
- **[Πολυπλοκότητα O(n² + log n)](../../questions/kahoot/kahoot-big-o-sum-of-terms.md)** (36% σωστές): Το 60% απάντησε False, θεωρώντας ότι το O(·) πρέπει να περιέχει έναν μόνο όρο· η έκφραση είναι σωστή, απλώς ισοδυναμεί με O(n²), γιατί ο κυρίαρχος όρος είναι το n².
- **[Πολυπλοκότητα μέτρησης ψηφίων](../../questions/kahoot/kahoot-count-digits.md)** (38% σωστές): Το 45% επέλεξε O(n), μπερδεύοντας την τιμή του n με το μέγεθος της εισόδου: ο αλγόριθμος κάνει μία επανάληψη ανά ψηφίο, όχι ανά μονάδα της τιμής.
- **[Η έξοδος του προεπεξεργαστή](../../questions/kahoot/kahoot-preprocessor-output.md)** (38% σωστές): Το 30% απάντησε «Εξαρτάται», χωρίς να έχει ξεκαθαρίσει τη θέση του προεπεξεργαστή στη σειρά προεπεξεργασία → μεταγλώττιση → συμβολομετάφραση → σύνδεση: ο προεπεξεργαστής κάνει πάντα μόνο αντικαταστάσεις κειμένου.
- **[Πολυπλοκότητα μέτρησης bit](../../questions/kahoot/kahoot-count-set-bits.md)** (43% σωστές): Το 32% επέλεξε O(n), μπερδεύοντας την τιμή του n με το πλήθος των bit του, που είναι περίπου $\log_2 n$.
- **[Πολυπλοκότητα πολλαπλασιασμού πινάκων](../../questions/kahoot/kahoot-matrix-multiplication.md)** (49% σωστές): Το 23% επέλεξε O(n²), μετρώντας μόνο τα N² στοιχεία του αποτελέσματος και όχι το εσωτερικό άθροισμα N γινομένων για το καθένα.
...
- [Γραμμική αναζήτηση σε αμφιθέατρο n × n](../../questions/kahoot/kahoot-seat-search-grid.md): 75% σωστές απαντήσεις
- [Ορισμός μακροεντολής](../../questions/kahoot/kahoot-define-macro.md): 74% σωστές απαντήσεις
- [Τι σημαίνει O(n)](../../questions/kahoot/kahoot-big-o-worst-case.md): 62% σωστές απαντήσεις
- [Πολυπλοκότητα πολλαπλασιασμού πινάκων](../../questions/kahoot/kahoot-matrix-multiplication.md): 49% σωστές απαντήσεις
- [Πολυπλοκότητα μέτρησης bit](../../questions/kahoot/kahoot-count-set-bits.md): 43% σωστές απαντήσεις
- [Πολυπλοκότητα μέτρησης ψηφίων](../../questions/kahoot/kahoot-count-digits.md): 38% σωστές απαντήσεις
- [Η έξοδος του προεπεξεργαστή](../../questions/kahoot/kahoot-preprocessor-output.md): 38% σωστές απαντήσεις
- [Πολυπλοκότητα O(n² + log n)](../../questions/kahoot/kahoot-big-o-sum-of-terms.md): 36% σωστές απαντήσεις
