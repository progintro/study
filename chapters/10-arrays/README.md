...
- **[Διεύθυνση στοιχείου πίνακα char](../../questions/kahoot/kahoot-char-array-address.md)** (19% σωστές): Το 52% επέλεξε `1041`, μετρώντας τις θέσεις σαν να ξεκινούσαν από το 1. Αφού το `array[0]` είναι στο 1000 και κάθε `char` πιάνει 1 byte, το `array[i]` είναι στο 1000 + i.
- **[Χαρακτήρας σε συμβολοσειρά](../../questions/kahoot/kahoot-string-char-index.md)** (27% σωστές): Το 47% επέλεξε «(κενό)», μετρώντας τις θέσεις από το 1. Το κενό είναι το `hello[5]`, γιατί η αρίθμηση στους πίνακες ξεκινά από το 0.
- **[Μέγεθος πίνακα int](../../questions/kahoot/kahoot-int-array-bytes.md)** (49% σωστές): Το 35% επέλεξε `4096`, θεωρώντας ότι ένας `int` είναι πάντα 4 bytes. Το πρότυπο της C δεν ορίζει το ακριβές μέγεθος του `int`· εξαρτάται από το σύστημα.
...
- [Πρόσβαση εκτός ορίων](../../questions/kahoot/kahoot-out-of-bounds.md): 85% σωστές απαντήσεις
- [Αντιγραφή πίνακα με ανάθεση](../../questions/kahoot/kahoot-array-assignment.md): 84% σωστές απαντήσεις
- [Ο δείκτης του πρώτου στοιχείου](../../questions/kahoot/kahoot-first-index.md): 82% σωστές απαντήσεις
- [Το τελευταίο στοιχείο πίνακα](../../questions/kahoot/kahoot-last-element.md): 81% σωστές απαντήσεις
- [Αρχικοποίηση με περισσότερες τιμές](../../questions/kahoot/kahoot-excess-initializers.md): 71% σωστές απαντήσεις
- [Δείκτης μέσα σε δείκτη](../../questions/kahoot/kahoot-nested-index.md): 69% σωστές απαντήσεις
- [Μέγεθος πίνακα int](../../questions/kahoot/kahoot-int-array-bytes.md): 49% σωστές απαντήσεις
- [Διεύθυνση στοιχείου πίνακα int](../../questions/kahoot/kahoot-int-array-address.md): 47% σωστές απαντήσεις
- [Χαρακτήρας σε συμβολοσειρά](../../questions/kahoot/kahoot-string-char-index.md): 27% σωστές απαντήσεις
- [Διεύθυνση στοιχείου πίνακα char](../../questions/kahoot/kahoot-char-array-address.md): 19% σωστές απαντήσεις
