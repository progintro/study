...
<a id="s5-1"></a><a id="κατηγορίες-τελεστών"></a>
...
<a id="s5-2"></a><a id="αριθμητικοί-τελεστές"></a>
...
<a id="s5-3"></a><a id="συγκριτικοί-τελεστές"></a>
...
<a id="s5-4"></a><a id="λογικοί-τελεστές"></a>
...
<a id="s5-5"></a><a id="bitwise-τελεστές"></a>
...
<a id="s5-6"></a><a id="ο-τελεστής-συνθήκης"></a>
...
<a id="s5-7"></a><a id="ο-τελεστής-μετατροπής-cast"></a>
...
<a id="s5-8"></a><a id="σιωπηρή-μετατροπή-τύπων"></a>
...
<a id="s5-9"></a><a id="ο-τελεστής-ανάθεσης"></a>
...
<a id="s5-10"></a><a id="συνδυαστικοί-τελεστές-ανάθεσης"></a>
...
<a id="s5-11"></a><a id="τελεστές-αύξησης-και-μείωσης"></a>
...
<a id="s5-12"></a><a id="ο-τελεστής-παράθεσης-κόμμα"></a>
...
<a id="s5-13"></a><a id="προτεραιότητα-και-προσεταιριστικότητα"></a>
...
<a id="s5-14"></a><a id="εκφράσεις-και-εντολές"></a>
...
<a id="s5-15"></a><a id="κατηγορίες-εντολών"></a>
...
<a id="s5-16"></a><a id="ροή-ελέγχου-οι-εντολές-if-και-if-else"></a>
...
<a id="s5-17"></a><a id="απομόνωση-του-πιο-σημαντικού-bit"></a>
...
<a id="s5-18"></a><a id="συνδυασμός-τιμών-με-bitwise-or"></a>
...
<a id="s5-19"></a><a id="μια-συνάρτηση-max-με-τον-τελεστή-συνθήκης"></a>
...
<a id="s5-20"></a><a id="cast-και-διαίρεση-double34"></a>
...
<a id="s5-21"></a><a id="πρόγραμμα-υπολογισμού-βαθμολογίας"></a>
...
<a id="s5-22"></a><a id="προτεραιότητα-στην-πράξη"></a>
...
<a id="s5-23"></a><a id="ιχνηλάτηση-εντολών-έκφρασης"></a>
...
<a id="s5-24"></a><a id="μέγιστο-με-if-else"></a>
...
- <a id="e5-1"></a>**[Ε5.1](#e5-1)** Τι δίνουν οι εκφράσεις `85 / 2`, `85.0 / 2`, `85 % 2` και `-7 / 2`;[^q1]
- <a id="e5-2"></a>**[Ε5.2](#e5-2)** Ποια από τα `0`, `1`, `42`, `-5` θεωρούνται «αληθή» σε μια συνθήκη της C;[^q2]
- <a id="e5-3"></a>**[Ε5.3](#e5-3)** Πόσο κάνει `0xF0 | 0x0F`, `0xF0 & 0x0F` και `3 << 2`;[^q3]
- <a id="e5-4"></a>**[Ε5.4](#e5-4)** Γιατί το `(int)42.67` δίνει `42` και όχι `43`;[^q4]
- <a id="e5-5"></a>**[Ε5.5](#e5-5)** Ποια η τιμή και ο τύπος της `40 + 2.0`;[^q5]
- <a id="e5-6"></a>**[Ε5.6](#e5-6)** Ποιες είναι οι τιμές των `x`, `y`, `z` μετά τις εντολές `x = 4; y = 7; z = ++y; y = z - (x++); z = x - (--y);`;[^q6]
- <a id="e5-7"></a>**[Ε5.7](#e5-7)** Γιατί μπορούμε να γράψουμε `x = y = 42`; Με ποια σειρά γίνονται οι αναθέσεις;[^q7]
- <a id="e5-8"></a>**[Ε5.8](#e5-8)** Πόσο κάνουν `5 * 6 + 3 * 4` και `90 * 50 / 100`;[^q8]
- <a id="e5-9"></a>**[Ε5.9](#e5-9)** Τι σημαίνει `if (x & 1 == 0)` και πώς το διορθώνουμε;[^q9]
- <a id="e5-10"></a>**[Ε5.10](#e5-10)** Ποια η διαφορά ανάμεσα σε έκφραση και εντολή;[^q10]

<!-- kahoot -->

### Kahoot από το αμφιθέατρο (Κ5.1–Κ5.3)

Ερωτήσεις που παίχτηκαν στις διαλέξεις, με το ποσοστό των φοιτητών που απάντησαν σωστά.

- <a id="k5-1"></a>**[Κ5.1](../../questions/kahoot/kahoot-cast-truncation.md)** Μετατροπή double σε int: 86% σωστές απαντήσεις
- <a id="k5-2"></a>**[Κ5.2](../../questions/kahoot/kahoot-num-divisible-3-31.md)** Ποιος αριθμός ικανοποιεί τη συνθήκη: 58% σωστές απαντήσεις
- <a id="k5-3"></a>**[Κ5.3](../../questions/kahoot/kahoot-post-pre-increment.md)** x++ και ++y: 48% σωστές απαντήσεις
...
### Ζέσταμα: από τις διαφάνειες (Α5.1–Α5.7)

- <a id="a5-1"></a>**[Α5.1](../../questions/slides/slides-lec05-bitwise-or-hex.md)** Η τιμή της 0xbeef | 0xcafe0000: Διάλεξη 5: Τελεστές και Εντολές, διαφάνεια 12 · ★☆☆ · multiple-choice · `slides-lec05-bitwise-or-hex`
- <a id="a5-2"></a>**[Α5.2](../../questions/slides/slides-lec05-cast-division.md)** Cast και διαίρεση: (double)3/4: Διάλεξη 5: Τελεστές και Εντολές, διαφάνεια 14 · ★☆☆ · trace · `slides-lec05-cast-division`
- <a id="a5-3"></a>**[Α5.3](../../questions/slides/slides-lec05-msb.md)** Απομόνωση του πιο σημαντικού bit: Διάλεξη 5: Τελεστές και Εντολές, διαφάνεια 11 · ★☆☆ · multiple-choice · `slides-lec05-msb`
- <a id="a5-4"></a>**[Α5.4](../../questions/slides/slides-lec05-operator-arity.md)** Τι τύπου τελεστές είναι;: Διάλεξη 5: Τελεστές και Εντολές, διαφάνειες 7-10, 13 · ★☆☆ · short-answer · `slides-lec05-operator-arity`
- <a id="a5-5"></a>**[Α5.5](../../questions/slides/slides-lec05-operator-as-function.md)** Οι αριθμητικοί τελεστές ως συναρτήσεις: Διάλεξη 5: Τελεστές και Εντολές, διαφάνεια 7 · ★☆☆ · short-answer · `slides-lec05-operator-as-function`
- <a id="a5-6"></a>**[Α5.6](../../questions/slides/slides-lec05-precedence.md)** Προτεραιότητα και προσεταιριστικότητα: Διάλεξη 5: Τελεστές και Εντολές, διαφάνεια 21 · ★☆☆ · trace · `slides-lec05-precedence`
- <a id="a5-7"></a>**[Α5.7](../../questions/slides/slides-lec05-ternary-max.md)** Συνάρτηση max με τον τελεστή συνθήκης: Διάλεξη 5: Τελεστές και Εντολές, διαφάνεια 13 · ★☆☆ · programming · `slides-lec05-ternary-max`

### Εργαστήριο (Α5.8)

- <a id="a5-8"></a>**[Α5.8](../../questions/labs/lab-lab03-birthdate.md)** Υπολογισμός ημέρας μίας δεδομένης ημερομηνίας: Εργαστήριο 3, Άσκηση 3 · ★☆☆ · programming · `lab-lab03-birthdate`

### Θέματα εξετάσεων (Α5.9–Α5.11)

- <a id="a5-9"></a>**[Α5.9](../../questions/exams/exam-2025-jan-q1.md)** Mystery: Εξέταση Ιανουαρίου 2025, Θέμα 1 · ★☆☆ · trace · `exam-2025-jan-q1`
- <a id="a5-10"></a>**[Α5.10](../../questions/exams/exam-2026-jan-q1.md)** Mystery: Εξέταση Ιανουαρίου 2026, Θέμα 1 · ★☆☆ · trace · `exam-2026-jan-q1`
- <a id="a5-11"></a>**[Α5.11](../../questions/exams/exam-2026-jun-q1.md)** Η συνάρτηση mystery: Εξέταση Ιουνίου 2026, Θέμα 1 · ★☆☆ · trace · `exam-2026-jun-q1`

### Σχετικές ασκήσεις από άλλα κεφάλαια

- **[Α2.12](../../questions/exams/exam-2023-fall-ex4-q3.md)** Rickroll Τριπλέτες: Online τελική εξέταση Δεκεμβρίου 2023, Εξέταση #4 (Rick Astley Themed), Θέμα 3 · ★★★ · programming · `exam-2023-fall-ex4-q3`
- **[Α3.7](../../questions/labs/lab-lab02-pyth.md)** Πυθαγόρειο θεώρημα: Εργαστήριο 2, Άσκηση 2 · ★☆☆ · programming · `lab-lab02-pyth`
- **[Α6.12](../../questions/labs/lab-lab03-root.md)** Υπολογισμός ριζών τριωνύμου: Εργαστήριο 3, Άσκηση 2 · ★★☆ · programming · `lab-lab03-root`
- **[Α6.2](../../questions/slides/slides-lec06-expression-statements.md)** Τιμές μετά από εντολές έκφρασης: Διάλεξη 6: Εντολές και Ροή Ελέγχου, διαφάνεια 7 · ★☆☆ · trace · `slides-lec06-expression-statements`
- **[Α6.5](../../questions/slides/slides-lec06-if-else-max.md)** Μέγιστο με if-else και εναλλακτικές: Διάλεξη 6: Εντολές και Ροή Ελέγχου, διαφάνεια 13 · ★☆☆ · short-answer · `slides-lec06-if-else-max`
- **[Α9.23](../../questions/exams/exam-2023-fall-ex6-q2.md)** Μήνυμα από τον Καίσαρα: Online τελική εξέταση Δεκεμβρίου 2023, Εξέταση #6 (Crypto Themed), Θέμα 2 · ★☆☆ · programming · `exam-2023-fall-ex6-q2`
- **[Α9.31](../../questions/exams/exam-2024-sep-q4.md)** Μετρητής λέξεων: Εξέταση Σεπτεμβρίου 2024, Θέμα 4 · ★★☆ · programming · `exam-2024-sep-q4`
...
- **[Α14.8](../../questions/slides/slides-lec14-str-plus-plus.md)** Η έκφραση *str++: Διάλεξη 14, διαφάνεια 34 · ★★☆ · short-answer · `slides-lec14-str-plus-plus`
- **[Α15.3](../../questions/slides/slides-lec15-complexity-grade.md)** Πολυπλοκότητα υπολογισμού βαθμολογίας: Διάλεξη 15, διαφάνεια 21 · ★☆☆ · short-answer · `slides-lec15-complexity-grade`
- **[Α18.12](../../questions/exams/exam-2023-fall-ex7-q2.md)** Κρυφό Μήνυμα: Online τελική εξέταση Δεκεμβρίου 2023, Εξέταση #7 (Star Wars Themed), Θέμα 2 · ★☆☆ · programming · `exam-2023-fall-ex7-q2`
