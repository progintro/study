...
### Αφαίρεση και οργάνωση σε πολλά αρχεία
...
### Αριθμοί κινητής υποδιαστολής: IEEE 754
...
### Εκτέλεση άλλων προγραμμάτων: `exec*` και `system`
...
### Οι προσδιοριστές `volatile`, `register`, `restrict` και `auto`
...
### Κλήση πριν τον ορισμό: το `prototype.c`
...
### Κλήση μέσω δείκτη σε συνάρτηση
...
### Άθροισμα με variadic συνάρτηση
...
### `volatile`, `register`, `restrict`, `auto` στην πράξη
...
- [Εντοπισμός σφάλματος μνήμης με τον gdb](../../questions/labs/lab-lab07-my_prog.md): Εργαστήριο 7, Άσκηση 6 · ★☆☆ · debug (κεφ. 10)
- [Υπολογισμός μισθών](../../questions/labs/lab-lab08-wages.md): Εργαστήριο 8, Άσκηση 4 · ★★☆ · debug (κεφ. 11)
- [Εξαρτήσεις ανάμεσα σε αρχεία](../../questions/slides/slides-lec23-dependencies.md): Διαλέξεις 23–24, διαφάνεια 15 (διάλεξη 24: διαφάνεια 16) · ★★☆ · short-answer (κεφ. 23)
- [Ένα σύστημα 40.000 γραμμών](../../questions/slides/slides-lec23-organize-40kloc.md): Διαλέξεις 23–24, διαφάνειες 11 και 14 (διάλεξη 24: διαφάνειες 12 και 15) · ★☆☆ · short-answer (κεφ. 23)

<!-- /exercises -->

## Ερωτήσεις αυτοαξιολόγησης

1. Τι σημαίνουν τα `T` και `U` για το `print_err` στα `err.o` και `init.o`;[^q1]
2. Τι δηλώνει το `const char * const p = message;`;[^q2]
3. Ποια η διαφορά ανάμεσα σε `int (*f)(char *);` και `int *f(char *);`;[^q3]
4. Πώς ξέρει η `printf` πόσα ορίσματα της δόθηκαν;[^q4]
5. Γιατί ο καταχωρητής κατάστασης μιας συσκευής διαβάζεται μέσω `volatile`;[^q5]
