...
def main():
    ...
    out = [
        ...
        "> διάλεξης σε κείμενο, παραδείγματα, κύρια σημεία, ορολογία, οδηγό ανάγνωσης",
        "> (διαφάνειες, σημειώσεις K04, εργαστήρια), συχνά λάθη, ερωτήσεις κατανόησης",
        "> (με τα Kahoot των διαλέξεων και το ποσοστό σωστών απαντήσεων) και ασκήσεις.",
        "",
