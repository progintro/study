...
## [Κεφάλαιο 0: Καλημέρα Κόσμε!](../chapters/00-hello-world/)
...
## [Κεφάλαιο 17: Δυαδική Αναζήτηση και Ταξινόμηση](../chapters/17-binary-search-sorting/)

- [Πολυπλοκότητα της δυαδικής αναζήτησης](../questions/slides/slides-lec17-binary-search-complexity.md): Διάλεξη 17: Δυαδική Αναζήτηση και Ταξινόμηση, διαφάνεια 18 · ★☆☆ · short-answer
- [Γρηγορότερα από O(n);](../questions/slides/slides-lec17-faster-than-linear.md): Διάλεξη 17: Δυαδική Αναζήτηση και Ταξινόμηση, διαφάνεια 11 · ★☆☆ · short-answer
- [Κρυμμένος αριθμός έως 10^9](../questions/slides/slides-lec17-guess-billion.md): Διάλεξη 17: Δυαδική Αναζήτηση και Ταξινόμηση, διαφάνεια 6 · ★☆☆ · short-answer
- [Αναζήτηση χρήστη στο Instagram](../questions/slides/slides-lec17-instagram.md): Διάλεξη 17: Δυαδική Αναζήτηση και Ταξινόμηση, διαφάνεια 19 · ★☆☆ · short-answer
- [Αναζήτηση σε πίνακα 100 ακεραίων](../questions/slides/slides-lec17-linear-search.md): Διάλεξη 17: Δυαδική Αναζήτηση και Ταξινόμηση, διαφάνεια 9 · ★☆☆ · programming
- [Η συνάρτηση swap](../questions/slides/slides-lec17-swap.md): Διάλεξη 17: Δυαδική Αναζήτηση και Ταξινόμηση, διαφάνεια 21 · ★☆☆ · programming
- [Δυαδική αναζήτηση σε ταξινομημένο πίνακα](../questions/slides/slides-lec17-binary-search.md): Διάλεξη 17: Δυαδική Αναζήτηση και Ταξινόμηση, διαφάνεια 14 · ★★☆ · programming
- [Το σφάλμα της δυαδικής αναζήτησης](../questions/slides/slides-lec17-binary-search-bug.md): Διάλεξη 17: Δυαδική Αναζήτηση και Ταξινόμηση, διαφάνεια 16 · ★★☆ · debug
- [Ο γρίφος του κρυμμένου αριθμού](../questions/slides/slides-lec17-guess-100.md): Διάλεξη 17: Δυαδική Αναζήτηση και Ταξινόμηση, διαφάνεια 5 · ★★☆ · short-answer
- [Η συνάρτηση what](../questions/exams/exam-2024-sep-q2.md): Εξέταση Σεπτεμβρίου 2024, Θέμα 2 · ★☆☆ · trace
...
## [Κεφάλαιο 24: Προχωρημένα Θέματα](../chapters/24-advanced-topics/)

- [Ο τυχερός αριθμός σε δυαδικό](../questions/slides/slides-lec24-binary-literal.md): Διάλεξη 24: Προχωρημένα Θέματα, διαφάνεια 32 · ★☆☆ · trace

## [Κεφάλαιο 25: Επίλυση Προβλημάτων #3](../chapters/25-problem-solving-3/)
...
## [Παράρτημα Α: How to Make? (προσκεκλημένη διάλεξη)](../chapters/26-make/)
